  ...
  return (
    ...
    <Box bg="gray.50" className="footer">
      <Container className="flexboxContainer" maxW="2xl">
        ...
        <Link
          href="https://www.facebook.com/profile.php?id=100090833054137"
          className="footerLinks"
        >
          <FaFacebookSquare className="search" size={35} color="primary.main" />
        </Link>
        <Link
          href="https://www.instagram.com/followyourheartenglish/"
          className="footerLinks"
        >
          <FaInstagramSquare
            className="search"
        ...
        <Link
          href="https://www.youtube.com/channel/UCG63H0-Bonh51PvCDBmdyuw"
          className="footerLinks"
        >
